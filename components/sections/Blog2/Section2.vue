<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[140px]">
        <div class="text-center mb-[40px] lg:mb-[73px]">
            ...
            <p class="text-quote md:text-lead-lg text-gray-600 mx-auto max-w-[691px]">
        ...
        <div class="grid grid-cols-1 gap-[30px] md:grid-cols-2 gap-y-[60px] lg:grid-cols-3">
            <div class="relative cursor-pointer">
                <div class="relative">
                    ...
                    <div
                        class="absolute w-full h-full left-0 z-0 top-0 translate-y-[30px] pl-[33px]"
                    >
                        <div
                ...
                <p class="text-text text-gray-500 mb-[15px]">
                    Lorem ipsum dolor sit amet consectetur adipiscing elit interdum ullamcorper sed
                    pharetra senectus donec nunc. Consequat semper viverra nam libero justo laoreet
            ...
            <div class="flex flex-col gap-8 md:col-span-2 lg:col-span-1">
                ...
                >
                    ...
                    <div class="relative flex-1 max-w-[133px]">
                        ...
                        <div
                            class="absolute w-full h-full left-0 z-0 top-0 translate-y-[13px] pl-[13px]"
                        >
                            <div
                                class="w-full h-full rounded-2xl bg-opacity-50 transition-all duration-200 bg-bg-10 group-hover:-translate-x-[10px] group-hover:-translate-y-[10px]"
                            ></div>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="relative flex-1 max-w-[133px]">
                        ...
                        >
                            <div
                                class="w-full h-full rounded-2xl bg-opacity-50 transition-all duration-200 bg-bg-3 group-hover:-translate-x-[10px] group-hover:-translate-y-[10px]"
                            ></div>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div class="relative flex-1 max-w-[133px]">
                        ...
                        >
                            <div
                                class="w-full h-full rounded-2xl bg-opacity-50 transition-all duration-200 bg-bg-5 group-hover:-translate-x-[10px] group-hover:-translate-y-[10px]"
                            ></div>
                        </div>
                    </div>
                </div>
