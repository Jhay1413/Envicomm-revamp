<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] text-center z-10 relative lg:mt-[99px]">
        <div class="text-center">
            <h2
                class="font-bold mx-auto text-gray-900 mb-5 md:mb-[30px] text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:w-[20ch]"
            >
                Advanced <span class="text-green-900">analytics</span> to grow your business
            </h2>
            <p class="text-quote md:text-lead-lg text-gray-500 mx-auto md:w-[47ch] mb-[50px]">
                Connect your conversations with the tools and services that you use to get the job
                done. With over 1,500 apps and a robust API
            </p>
        </div>
