    ...
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] mx-auto max-w-[1090px]">
        ...
        <div class="mx-auto max-w-[866px]">
            ...
            <ul class="list-disc pl-5">
                ...
                <li>
                    A Bachelor’s Degree in Design (or related field) or equivalent professional
                    experience
                </li>
                <li>
            ...
            <p class="text-text">
                Product knowledge: Deeply understand the technology and features of the product area
            ...
            <p class="text-text">
                ...
                analyses, user flows, low fidelity wireframes, high fidelity mockups, prototypes,
                etc.) that solve real user problems through the user experience.
            </p>
            <p class="text-text">
                Communication: Communicate the results of UX activities within your product area to
                the design team department, cross-functional partners within your product area, and
                other interested Superformula team members using clear language that simplifies
                complexity.
            </p>
            <div class="w-full opacity-10 h-[1px] bg-[#061224] mt-[50px] mb-[34px]"></div>
            <div class="flex items-center justify-between flex-col md:flex-row gap-[30px]">
                ...
                <div class="flex items-center gap-[15px]">
                    ...
                    >
                        <NuxtImg
                            ...
                            alt="social icon"
                        />
                        <p class="text-text text-[#37404E]">Pin</p>
                    </div>
                </div>
            </div>
        </div>
