<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] mx-auto lg:mt-[141px] max-w-[1248px]">
        <div class="text-center relative mb-[70px] md:mb-[90px]">
            ...
            <p class="text-quote md:text-lead-lg text-gray-600 mx-auto md:w-[51ch]">
                Aliquam a augue suscipit, luctus neque purus ipsum neque dolor primis a libero
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-text text-gray-500">
                        Etiam amet mauris suscipit in odio integer congue metus vitae arcu mollis
                        blandit ultrice ligula egestas and magna suscipit lectus magna suscipit
                        luctus blandit vitae
                    </p>
                </div>
            </div>
            <div class="flex items-start gap-3">
