  ...
  >
    <div class="md:max-w-[45%] text-white">
      ...
      <p class="text-lg 4k:text-3xl">
        DENR-accredited PCO, a professional managing your establishment's
        environmental compliance and pollution control programs effectively.
      </p>
  ...
  <section id="cto-new" class="py-10">
    <div class="container">
      ...
      <ul class="4k:text-2xl list-disc list-inside mb-10 ml-[19px]">
        ...
        <li class="mb-2">
          Consultation with regards their Pollution Control Officer (PCO)
          accreditation
        </li>
      </ul>
      <h4
