  ...
  >
    <div class="md:max-w-[40%] text-black">
      ...
      <p class="text-lg 4k:text-3xl">
        ...
        tortor, vehicula consectetur neque at, pharetra dictum lorem. Vivamus
        molestie facilisis turpis, ac condimentum dolor luctus a. Nulla ut
        tincidunt nisi, ultricies sollicitudin quam. Nunc urna justo, finibus
        quis vestibulum eget, blandit a odio. Morbi tempus elit ac felis
        hendrerit, a bibendum arcu aliquet. In faucibus tincidunt nibh, nec
        sollicitudin metus. Aenean lacinia ac elit sit amet sagittis. Aliquam
        sit amet mi sed nisl congue consequat.
      </p>
    </div>
  </section>
  <!-- body section  -->
