  ...
  >
    <div class="md:max-w-[45%] text-white">
      ...
      <p class="text-lg 4k:text-3xl">
        DENR Special Land Use Permit allows temporary, specific use of forest
        lands or public domains for activities like ecotourism, without
      ...
      <section id="tsd-new" class="py-10">
        ...
        <ul class="4k:text-2xl list-disc list-inside mb-10 ml-[19px]">
          ...
          <ul class="4k:text-2xl list-disc list-inside mb-2 ml-[19px]">
            ...
            <li class="mb-2">
              Activity, Description of the Project Development, Site
              Development.
            </li>
            <li class="mb-2">
        ...
        <ul class="4k:text-2xl list-disc list-inside mb-10 ml-[19px]">
          ...
          <ul class="4k:text-2xl list-disc list-inside mb-2 ml-[19px]">
            ...
            <ul class="4k:text-2xl list-disc list-inside mb-2 ml-[19px]">
              <li class="mb-2">
                Certified true copy of the Securities and Exchange Commission
              ...
              <li class="mb-2">
                ...
                Board ofTrustees, etc.) designating the authorized
          ...
          <li class="mb-2">
            Provision of Proof of Capability - Bank Certification
          </li>
          <li class="mb-2">LGU Endorsement (if available)</li>
          <li class="mb-2">
            Barangay Certificate stating that there are no existing indigenous
            people in the area
          </li>
          <li class="mb-2">
