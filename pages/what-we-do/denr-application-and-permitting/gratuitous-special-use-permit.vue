  ...
  >
    <div class="md:max-w-[45%] text-white">
      ...
      <p class="text-lg 4k:text-3xl">
        The Gratuitous Special Use Permit from DENR allows free, temporary use
        of forestlands or protected areas for non-commercial, public interest
        activities.
      </p>
    ...
    <div class="container">
      ...
      <section id="tsd-new" class="py-10">
        ...
        <ul class="4k:text-2xl list-disc list-inside mb-10 ml-[19px]">
          ...
          <li class="mb-2">
            Payment of Work Financial Plan provided by the NCIP in securing the
            CNO
          </li>
          <li class="mb-2">
          ...
          <li class="mb-2">
            Proof that the proposed project is indicated in the Forest Land Use
            Plan (FLUP) and within the ambit of the approved Comprehensive Land
            Use Plan (CLUP)
          </li>
