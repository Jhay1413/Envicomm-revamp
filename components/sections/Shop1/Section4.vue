        ...
        <div class="grid grid-cols-1 items-center gap-[30px] lg:grid-cols-2 xl:grid-cols-3">
            ...
            >
                <NuxtLink class="flex items-center" to="/single-product"
                    ...
                    <div class="">
                        <p
                            class="font-bold mb-3 text-[18px] leading-[21px] lg:text-[26px] lg:leading-[32px]"
                        >
                            Bass ultra x-203. Head phone
                        </p>
                        <div class="flex items-center gap-3">
                            <span
                                class="text-[20px] leading-[24px] lg:text-[26px] lg:leading-[32px]"
                                >$29.8</span
                            ><span
                                class="text-gray-500 strike line-through text-[20px] leading-[24px] lg:text-[26px] lg:leading-[32px]"
                                >$29.8</span
                            >
                        </div>
                    </div>
