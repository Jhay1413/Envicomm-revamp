<template>
    <div
        class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] flex flex-col gap-8 lg:mt-[120px] lg:flex-row xl:gap-[88px]"
    >
        <div>
            <h1
            ...
            <p class="text-excerpt text-gray-600">
                Ac sapien purus tristique neque nibh vitae faucibus non phasellus vulputate nulla in
                eget amet, risus
            </p>
        </div>
