<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[150px]">
        <div class="rounded-2xl px-5 py-24 lg:pt-[96px] lg:px-[122px] lg:pb-[139px] bg-gray-100">
            ...
            <p
                class="text-quote md:text-lead-lg text-gray-600 mx-auto text-center max-w-[509px] mb-[30px] lg:mb-[60px]"
            >
            ...
            <div class="grid grid-cols-1 gap-y-8 gap-x-[30px] lg:grid-cols-2">
                ...
                >
                    ...
                    <p class="text-text text-gray-600 mb-[30px]">
                        Even factoring differences in body weight between children and adults into
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        />
                        <div>
                            <p class="text-lead font-bold mb-[3px]">Jane Cooper</p>
                ...
                >
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        />
                        <div>
                            <p class="text-lead font-bold mb-[3px]">Wade Warren</p>
                ...
                >
                    ...
                    <p class="text-text text-gray-600 mb-[30px]">
                        “It has been an absolute pleasure dealing with Scan during the lockdown. Our
                        church began to livestream our services, and Scan had a great selection of
                        hardware....”
                    </p>
                    <div class="flex items-center gap-6">
                        <NuxtImg
                        ...
                        />
                        <div>
                            <p class="text-lead font-bold mb-[3px]">Leslie Alexander</p>
                ...
                >
                    ...
                    <p class="text-text text-gray-600 mb-[30px]">
                        “I was also lucky enough to read @Coding_Career early and I was thoroughly
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        />
                        <div>
                            <p class="text-lead font-bold mb-[3px]">Jenny Wilson</p>
