<template>
    ...
    >
        ...
        <p class="font-bold mb-6 md:mb-9">
            ...
            light inside. Other perfect oh plants, for and again. I’ve honey feeling. Caring
            dreamland projects noteworthy than minimal, their it oh pretty feeling may. Include pink
            be.
        </p>
        ...
        <p class="mb-6 md:mb-9">
            Tortor placerat bibendum consequat sapien, facilisi facilisi pellentesque morbi. Id
            conse ctetur ut vitae a massa a. Lacus ut bibendum sollicitudin fusce sociis mi. Dictum
            volutpat praesent ornare accumsan elit venenatis. Congue sodales nunc quis ultricies
        ...
        <p class="mb-6 md:mb-9">
            Thirty there & time wear across days, make inside on these you. Can young a really,
            ...
            white dreamy dramatically place everything although. Place out apartment afternoon
        ...
        <div class="flex gap-4 mb-6 flex-col md:flex-row md:mb-9">
            <div class="flex-1">
                <p class="mb-6 md:mb-9">
                    TThirty there & time wear across days, make inside on these you. Can young a
                    really, roses blog small of song their dreamy life pretty? Because really duo
                    living to noteworthy bloom bell. Transform clean daydreaming cute twenty process
                    rooms cool. White white dreamy dramatically place everything although.
                </p>
                <p>
                    White white dreamy dramatically place everything although. Place out apartment
                    afternoon whimsical kinder, little romantic joy we flowers handmade. Thirty she
                    a studio of she whimsical projects, afternoon effect going an floated maybe.
                </p>
            </div>
            <div>
                <NuxtImg
        ...
        <p class="mb-8 md:mb-12">
            Tortor placerat bibendum consequat sapien, facilisi facilisi pellentesque morbi. Id
            consectetur ut vitae a massa a. Lacus ut bibendum sollicitudin fusce sociis mi. Dictum
            volutpat praesent ornare accumsan elit venenatis. Congue sodales nunc quis ultricies
        ...
        <div class="md:mb-[120px] mb-[60px]">
            ...
            >
                ...
                <p
                    class="bg-gray-100 rounded-2xl rounded-tl-none pt-7 pl-7 text-gray-900 flex-1 pr-[15px] pb-[30px]"
                >
                    White white dreamy drama tically place everything although. Place out apartment
        ...
        <form>
            ...
            <div class="flex items-start justify-between w-full flex-col gap-8 md:flex-row">
                <div class="flex items-start gap-3">
                    ...
                    <span class="text-md text-gray-400 max-w-[40ch]"
