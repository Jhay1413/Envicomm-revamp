<template>
    <div class="full-width bg-bg-7">
        <div
            class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] flex items-center flex-col mx-auto relative md:flex-row lg:mt-[150px] gap-[35px] md:gap-[85px] pt-[143px] pb-[100px] max-w-[1320px]"
        >
            <div class="flex-1 absolute bottom-0 right-0 max-w-[667px] aspect-[667/600]">
                <NuxtImg
                    class="h-full w-full object-cover"
                    src="/assets/images/main-imgs/header-01.png"
                    alt="Img"
                />
            </div>
            <div class="flex-1 max-w-[667px]">
                ...
                <p class="text-quote md:text-lead-lg text-gray-600 mb-[50px]">
                    With our expertise and comprehensive documentation services, we ensure that you
                    remain compliant with environmental regulations while striving to create a
